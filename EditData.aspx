<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="EditData.aspx.vb" Inherits="KMUReg.EditData" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cpMain" runat="server">
    ...
    <asp:UpdatePanel runat="server">
        <ContentTemplate>
                    ...
                    <div class="panel col-xs-12" style="margin-bottom: 15px">
                        <div class="col-xs-6 text-right" style="margin-bottom: 15px">
                            <div class="input-group">
                                <asp:TextBox ID="txtFileNo" runat="server" MaxLength="10" Placeholder="شماره پرونده" ToolTip="شماره پرونده" CssClass="form-control" onFocus="this.select()"></asp:TextBox>
                                <asp:LinkButton runat="server" ID="btnSearchByFileNo" CssClass="input-group-addon">
                        ...
                        <div class="col-xs-6 text-right" style="margin-bottom: 15px">
                            <div class="input-group">
                                <asp:TextBox ID="txtNationalCode" runat="server" MaxLength="10" Placeholder="* کدملی" ToolTip="کدملی" CssClass="form-control" onFocus="this.select()"></asp:TextBox>
                                <asp:LinkButton runat="server" ID="btnSearchByNationalCode" CssClass="input-group-addon">
                                <span aria-hidden="true" class="glyphicon glyphicon-search"></span>
                                </asp:LinkButton>
                            </div>
                        </div>
            ...
            <asp:Panel runat="server" ClientIDMode="Static" ID="pnlSelectContract" class="modal fade" role="dialog">
                <asp:Panel runat="server" ID="pnlSelectContractBack" Visible="false" class='modal-backdrop fade in' Style='height: 100%;'></asp:Panel>
                    ...
                    <div class="modal-content">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div class="col-xs-12">
                                    <div class="table-responsive">
                                        <asp:GridView runat="server" ID="grdContract" AutoGenerateColumns="false">
                                            <Columns>
                                                <asp:TemplateField HeaderText="تاریخ مراجعه">
                                                    <ItemTemplate>
                                                        <asp:HiddenField runat="server" ID="hfID"></asp:HiddenField>
                                                        <asp:Label runat="server" ID="lblContractDateOf"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="علت مراجعه">
                                                    <ItemTemplate>
                                                        <asp:Label runat="server" ID="lblCC"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="توضیحات پزشک">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:Button runat="server" ID="btnEdit" Text="ویرایش" CssClass="btn-default"></asp:Button>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
                            ...
                            <div class="panel-footer text-left">
                                <asp:Button runat="server" ID="btnCancelSelectContract" Text="انصراف" CssClass="btn-danger" />
                            </div>
                        </div>
                    </div>
                </div>
